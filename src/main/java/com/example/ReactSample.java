...
public class ReactSample {
	...
	final static List<String> basket1 = Arrays
	...
	final static List<String> basket3 = Arrays
...
//		cache();
	...
	private static void streams() {
		...
		List<String> names = Stream.of("Eric", "Elena", "Java").collect(Collectors.toList());;
		...
		if (names.stream().anyMatch(s ->{
				if (s.contentEquals("Eric")) {
					return true;
				}else {
					return false;
				}
